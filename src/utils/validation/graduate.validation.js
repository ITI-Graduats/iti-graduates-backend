...
const graduateValidationSchema = (branches) =>
    Yup.object()
        .shape({
            ...
            cityOfBirthplace: Yup.string().required(
                "City of Birthplace is required"
            ),
            ...
            branchesYouCanTeachIn: Yup.array()
                .of(
                    Yup.string().when("$branchesYouCanTeachIn", {
                        is: () => branches.length,
                ...
                .test(
                    "uniqueness",
                    "branches duplication isn't allowed!",
                    (value) => {
    ...
    Yup.object()
        .shape({
            ...
            branchesYouCanTeachIn: Yup.array()
                ...
                .test(
                    "uniqueness",
                    "branchesYouCanTeachIn duplication isn't allowed!",
                    (value) => {
                        if (!value || value.length === 0) return true;
                        return new Set(value).size === value.length;
                    }
